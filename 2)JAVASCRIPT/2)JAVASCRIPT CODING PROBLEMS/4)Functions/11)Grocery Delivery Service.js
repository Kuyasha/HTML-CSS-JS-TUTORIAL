/*
Suppose you're working on a project for an online grocery delivery service, and
you have an array of product objects that represent the available products in the
store.
...
Requirement 2:
You need to implement a function searchAndBuyProduct that allows the user to search
for a product by its name and buy it if it is in stock. The function should take
two parameters:
