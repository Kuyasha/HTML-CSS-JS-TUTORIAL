/*
Problem statement:-
You run a shopping mall and to store customer's list you use a nested object
consisting of different objects.


Requirements:-
Create a function calculatePrice  which should take an object as it's parameter.
It should be able to calculate the total price after taking price and quantity into
